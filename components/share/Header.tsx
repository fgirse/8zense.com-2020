...
const Header = () => {
  return (
    <header className="flex flex-col lg: text-white items-center justify-between bg-neutral-600">
      <div
        id=""
        className="bg-neutral-600 w-min-5xl h-20 flex flex-row items-center justify-between  
      ...
      >
        ...
        <SignedOut>
          <div className=" flex flex-row justify-end items-baseline gap-x-3">
